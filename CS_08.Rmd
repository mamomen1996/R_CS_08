---
title: "Using Classification algorithms in financial markets (Stock Market Prediction)"
...
data  # we don't access today's information at the beginning of the day (except RSI), we access previous days information
```
...
For more information check the [Github](https://github.com/mamomen1996/R_CS_08) repository.